...
if ( ! class_exists( 'LayoutModuleFooter' ) ) {
	class LayoutModuleFooter extends LayoutModule {
		...
		function __construct() {
			$this->_name = _x( 'Footer', 'module', 'it-l10n-Builder-Everett' );
			$this->_description = __( 'This module adds a place for the footer to render. Most layouts will have this module at the bottom of the layout.', 'it-l10n-Builder-Everett' );
