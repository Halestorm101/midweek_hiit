...
Version History
	...
	1.12.3 - 2016-07-06 - Chris Jean
		Updated builder_set_minimum_memory_limit() to be compatible with PHP 7.1.0.
*/
...
function builder_show_setup_tab_notice() {
	ITUtility::show_status_message( sprintf( __( 'Go to Builder\'s <a href="%s">Setup page</a> to finish setting up the Builder theme.', 'it-l10n-Builder-Everett' ), admin_url( 'admin.php?page=theme-settings&editor_tab=setup&theme_activation=1' ) ) );
}
